...
var Translations = map[string]map[string]string{
	"ru": {
		...
		"enter_category_name_for_limit": "Введите название категории для изменения лимита:",
	...
	"en": {
		...
		"enter_category_name_for_limit": "Enter the name of the category to change the limit:",
